 ...
 * 
 */
public class RejectOrder extends DalBaseProcess {
  ...
  public void execute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      purchaseorder.setB2bpoOrderstatus("OUT");

      StringBuilder newReqChanges = new StringBuilder();
      newReqChanges.append(getDateTimeString(new Date()));
      newReqChanges.append(" - ");
      newReqChanges.append("Reason: " + reply);
      newReqChanges.append("\n");
      newReqChanges.append(getDateTimeString(new Date()));
      newReqChanges.append(" - ");
      newReqChanges.append("Purchase Order Rejected");
      newReqChanges.append("\n");
      ...
      ActivityLogUtils.log(OBContext.getOBContext().getUser(),
          "b2bpo_activitylog_ordermanualrejected", purchaseorder);
