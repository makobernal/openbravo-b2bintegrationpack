 ...
 * 
 */
public class AcceptVendorChanges extends DalBaseProcess {
  ...
  public void execute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      newReqChanges.append("Vendor proposed modifications accepted");
      newReqChanges.append("\n");
      ...
      ActivityLogUtils.log(purchaseorder.getBusinessPartner().getADUserList().get(0),
          "b2bpo_activitylog_acceptvendorchanges", purchaseorder);
